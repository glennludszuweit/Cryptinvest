...
struct API {
    ...
    static let coingeckoGetCoinApiQuery: String = "?localization=false&tickers=false&market_data=true&community_data=false&developer_data=false&sparkline=false"
}
