...
struct API {
    ...
    static let coingeckoGetCoinApiQuery: String = "?localization=false&tickers=false&market_data=false&community_data=false&developer_data=false&sparkline=false"
}
